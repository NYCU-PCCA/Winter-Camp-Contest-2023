...
{
	\stepcounter{ncase}
	\IfFileExists{../problem/#1/data/sample/\arabic{ncase}.in}
    {
		\vspace{-1mm}
		%\begin{paracol}{2}
			\subsection*{Sample Input \arabic{ncase}}
			\lstinputlisting{../problem/#1/data/sample/\arabic{ncase}.in}
			%\switchcolumn
			\subsection*{Sample Output \arabic{ncase}}
			\lstinputlisting{../problem/#1/data/sample/\arabic{ncase}.ans}
		%\end{paracol}
		\testdata{#1}
    }{}
}
