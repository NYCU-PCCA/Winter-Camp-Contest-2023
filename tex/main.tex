...
{
	\fancyhf{}
	\fancyhead[C]{\includegraphics[width=1\textwidth]{image/header.png}\\Winter Camp Contest 2023}
...
{
	\stepcounter{ncase}
	\IfFileExists{../problem/#1/data/sample/0\arabic{ncase}.in}
    {
		\vspace{-1mm}
		%\begin{paracol}{2}
			\subsection*{Sample Input \arabic{ncase}}
            \begin{minipage}{\linewidth}
                \lstinputlisting{../problem/#1/data/sample/0\arabic{ncase}.in}
            \end{minipage}
			%\switchcolumn
			\subsection*{Sample Output \arabic{ncase}}
            \begin{minipage}{\linewidth}
                \lstinputlisting{../problem/#1/data/sample/0\arabic{ncase}.ans}
            \end{minipage}
		%\end{paracol}
		\testdata{#1}
    }{}
...
%\tableofcontents
%\vspace*{8mm}
\problem{A}{ATCG}{1}{2048}
\problem{B}{Buying Mascots}{8}{2048}
\problem{C}{Colorful Pictures}{3}{2048}
\problem{D}{Duo of Magicians}{1}{2048}
\problem{E}{Exterior}{3}{2048}
\problem{F}{Formidable Team}{3}{2048}
\problem{G}{Genetic Sequence Searching}{5}{2048}
\problem{H}{Heritage in the PCCA Kingdom}{20}{2048}
\problem{I}{Interval Cover}{1}{2048}
\problem{J}{Jewelry Box}{2}{2048}
\problem{K}{$k$-restricted Induced Subgraphs}{2}{2048}
\problem{L}{Linear Classifers}{2}{2048}
\problem{M}{Mini Factorization Challenge}{2}{2048}
\problem{N}{Nancy's Numbers}{2}{2048}
\end{document}
